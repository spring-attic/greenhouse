...
<fb:serverfbml style="width: 625px;">
	<script type="text/fbml">
		<fb:fbml>
			<fb:request-form action='<u:absoluteUrl value="/invite/facebook" />?skip=1' method="POST" invite="true" type="Greenhouse" content="Join me in The Greenhouse! It's the best way to exchange Spring ideas and information with other developers. <fb:req-choice url='http://greenhouse.springsource.org' label='Join the Greenhouse' />">
