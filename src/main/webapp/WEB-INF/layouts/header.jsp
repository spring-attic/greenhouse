...
<div id="topbar">
	...
	<c:if test="${currentUser != null}">
		...
		<a href="${profileUrl}">${currentUser.firstName}</a> | <a href="<c:url value="/invite" />">Invite</a> | <a href="<c:url value="/settings" />">Settings</a> | <a href="<c:url value="/signout" />">Sign Out</a>
	</c:if>
</div>
<h1>
