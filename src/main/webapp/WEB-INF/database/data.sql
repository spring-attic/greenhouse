...
insert into EventSession (event, title, startTime, endTime, description, hashtag, track) values (1, 'Mastering MVC 3', '2010-10-20 16:45:00', '2010-10-20 18:15:00',
	'A deep-dive into the latest capabilities of Spring MVC, Spring%27s REST-ful web application development platform.', '#web101', 'web');
insert into EventSessionLeader (event, session, leader) values (1, 1, 1);

insert into EventSession (event, title, startTime, endTime, description, hashtag, track) values (1, 'Inside Web Flow 3 Development', '2010-10-20 18:45:00', '2010-10-20 20:15:00',
	'A look inside the development of Spring Web Flow 3, the next-generation version of Spring%27s stateful controller framework for orchestrating multi-step user dialogs.', '#web102', 'web');
insert into EventSessionLeader (event, session, leader) values (1, 2, 1);

insert into EventSession (event, title, startTime, endTime, description, hashtag, track) values (1, 'Developing Social-Ready Web Applications', '2010-10-21 16:45:00', '2010-10-21 18:15:00',
...
insert into EventSession (event, title, startTime, endTime, description, hashtag, track) values (1, 'Choices in Moble Application Development', '2010-10-21 18:45:00', '2010-10-21 20:15:00',
...
insert into EventSession (event, title, startTime, endTime, description) values (2, 'Mastering MVC 3', '2010-10-20 16:45:00', '2010-10-20 18:15:00',
	'A deep-dive into the latest capabilities of Spring MVC, Spring%27s REST-ful web application development platform.');
