...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (1, 1, 'Mastering MVC 3', '2010-10-20 16:45:00', '2010-10-20 18:15:00',
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (1, 2, 'Inside Web Flow 3 Development', '2010-10-20 18:45:00', '2010-10-20 20:15:00',
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (1, 3, 'Developing Social-Ready Web Applications', '2010-10-21 16:45:00', '2010-10-21 18:15:00',
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (1, 4, 'Choices in Moble Application Development', '2010-10-21 18:45:00', '2010-10-21 20:15:00',
