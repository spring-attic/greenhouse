        ...
        function() {
	        ...
	        function activityNotificationHandler(response) {
		        ...
		        for (var i=0; i<activityItems.length; i++) {
			        ...
			        $("<li></li>").addClass("newItem").append($("<img/>", {
				        "src" : activity.memberPictureUrl
			        }).addClass("profile")).append("<p>" + activity.text + "</p>").append($("<img/>", {
				        "src" : activity.imageUrl
			        }).addClass("activity")).prependTo("#recentActivityList");
