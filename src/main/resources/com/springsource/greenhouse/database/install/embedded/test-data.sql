...
insert into ServiceProvider (name, displayName, implementation, apiKey, secret, appId) values ('facebook', 'Facebook', 'com.springsource.greenhouse.connect.providers.FacebookServiceProvider', '21aa96c8bc23259d0dd2ab99e496c306', 'f9f627194d471fb915dfbc856d347288', 157702280911244);
...
insert into Event (title, timeZone, startTime, endTime, slug, description, memberGroup) values ('SpringOne2gx', 'America/Chicago', '2011-10-19 22:00:00Z', '2011-10-22 22:00:00Z', 'chicago', 'SpringOne 2GX is a one-of-a-kind conference for application developers, solution architects, web operations and IT teams who develop, deploy and manage business applications.', 1);
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 3, 'How to create a secure Spring application?', '2011-10-20 13:30:00Z', '2011-10-20 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 4, 'Visibility into Spring apps with tc server Spring Edition', '2011-10-20 13:30:00Z', '2011-10-20 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 5, 'Virtualizing your Java applications', '2011-10-20 13:30:00Z', '2011-10-20 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 6, 'Introduction to the Force.com Cloud Platform', '2011-10-20 13:30:00Z', '2011-10-20 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 7, 'Transforming Groovy', '2011-10-20 13:30:00Z', '2011-10-20 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 8, 'Gaelyk for Google App Engine', '2011-10-20 13:30:00Z', '2011-10-20 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 9, 'Grails in the Real World', '2011-10-20 13:30:00Z', '2011-10-20 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 10, 'Grails: Bringing Rad Productivity to the JVM Part I', '2011-10-20 13:30:00Z', '2011-10-20 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 11, 'What''s new in Spring-WS 2.0?', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 12, 'Killer Flex RIAs with Spring ActionScript', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 13, 'Clustering and load-balancing tc Server / httpd', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 14, 'Devs to Ops: Monitoring/Management in the Real World with Hyperic', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 15, 'Application Development with VMforce.com', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 16, 'Slimmed Down Software: A Lean, Groovy Approach', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 17, 'GORM Inside And Out', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 18, 'Creating a Dynamic Portal using Grails', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 19, 'Grails: Bringing Rad Productivity to the JVM Part II', '2011-10-20 15:15:00Z', '2011-10-20 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 20, 'Introduction to Spring Roo', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 21, 'Mastering MVC 3', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 22, 'Improve the performance of your Spring app', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 23, 'Build/run/manage elastic applications with Monterey', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 24, 'Understanding Data Access in VMforce.com', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 25, 'Improving your Groovy Code Quality', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 26, 'Acceptance Testing with Groovy', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 27, 'Tuning Grails applications', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 28, 'Extending Grails with the Plugin System', '2011-10-20 17:45:00Z', '2011-10-20 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 29, 'Developer Tools to Push your Productivity', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 30, 'RIAs with Spring Web Flow and JSF 2', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 31, 'Using Ehcache to overcome JVM gc limitations', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 32, 'The Private Cloud: Amazon, Google ...and You!', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 33, 'Inside the Force.com Cloud Platform', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 34, 'Groovy Web Services, Part I: REST', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 35, 'Groovy.DSLs(from: beginner, to: expert)', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 36, 'Grails Integration Strategies ', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 37, 'Grails Without SQL', '2011-10-20 19:45:00Z', '2011-10-20 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 38, 'What''s new in Spring Integration 2.0?', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 39, 'Building Content Rich Applications with Spring MVC', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 40, 'Diagnosing Performance Issues with Spring Insight before it''s a Problem', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 41, 'Hello, RooBot: Writing and Distributing Your Own Spring Roo Add-Ons.', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 42, 'Special Topic: Lightning VMforce Overview', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 43, 'Groovy Web Services, Part II: SOAP and JAX-WS', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 44, 'Advanced GORM - Performance, Customization and Monitoring ', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 45, 'Grails 1.3 Update', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 46, 'Building SOFEA''s with Grails and YUI', '2011-10-20 21:30:00Z', '2011-10-20 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 47, 'Technical Keynote', '2011-10-21 00:30:00Z', '2011-10-21 01:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 48, 'Creating next-gen of on-line transaction authorization', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 49, 'OAuth for Spring Security', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 50, 'Introduction to Tomcat 7', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 51, 'Deep-dive into hypervisors and virtualization', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 52, 'Google Web Toolkit 101', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 53, 'Groovy Update: to Infinity and Beyond!', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 54, 'Functional Programming in Groovy', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 55, 'Grails Spring Security Plugins', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 56, 'Grails Layouts & Sitemesh', '2011-10-21 13:30:00Z', '2011-10-21 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 57, 'Spring and Java EE 6', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 58, 'Having Fun with RestTemplate', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 59, 'Spring AMQP', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 60, 'Developing Java applications with Cloud Services', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 61, 'Building business apps with GWT and Roo', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 62, 'Metaprogramming With Groovy', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 63, 'Unit and Functional Testing using Groovy', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 64, 'Plugin-oriented architecture for large-scale Grails development', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 65, 'Tomorrow''s Tech Today: HTML 5 + Grails', '2011-10-21 15:15:00Z', '2011-10-21 16:45:00Z',
	'It''s easy for a Grails application to grow to an unmanageable size as more and more features are added. Fortunately, Grails comes with a built-in mechanism for separating an application into different concerns: plugins!',
	'#ghtml5', 'grf', 1, 9);
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 66, 'Payments in one API', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 67, 'Developing Social-Ready Web Applications', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 68, 'Low latency and linear scalability with a Data Grid', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 69, 'Supercharging Your App thru Virtualization', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 70, 'How to Build and Optimize Cloud-based Apps for Speed', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 71, 'Groovy and Concurrency', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 72, 'DSL Evolution for Groovy Developers', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 73, 'Database Migrations in Grails', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 74, 'Flying with Griffon, 2010 style', '2011-10-21 17:45:00Z', '2011-10-21 19:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 75, 'Concurrent and Distributed Applications with Spring', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 76, 'Choices in Mobile Application Development', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 77, 'Scaling Spring Apps with Cloud Storage', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 78, 'Code2Cloud', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 79, 'Google App Engine for Business 101', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 80, 'Concurrency with GPars', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 81, 'Tools for DSLs in Groovy', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 82, 'Extreme Scaffolding & User Interface Techniques in Grails', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 83, 'Griffon Plugin Development', '2011-10-21 19:45:00Z', '2011-10-21 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 84, 'New Persistence Features in Spring Roo 1.1', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 85, 'Harnessing the Power of HTML 5', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 86, 'Case Study: EMC Next-Gen ERP Integration Architecture', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 87, 'Using Spring with Non-relational Databases ', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 88, 'Google Data Analysis and Machine Learning for Your App', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 89, 'Code Generation on the JVM: Writing Code that Writes Code', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 90, 'Smarter Testing Tools with Spock', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 91, 'Grails Sans SQL', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 92, 'Griffon for the Enterprise', '2011-10-21 21:30:00Z', '2011-10-21 23:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 93, 'Configuration Enhancements in Spring 3.1', '2011-10-22 13:30:00Z', '2011-10-22 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 94, 'Rapid RIAs with Spring Flex and Roo', '2011-10-22 13:30:00Z', '2011-10-22 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 95, 'Case Study: Migrating Hyperic HQ from EJB to Spring', '2011-10-22 13:30:00Z', '2011-10-22 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 96, 'Developing Applications for the Cloud', '2011-10-22 13:30:00Z', '2011-10-22 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 97, 'Functional Web Testing with Geb and Spock', '2011-10-22 13:30:00Z', '2011-10-22 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 98, 'Gradle - A Better Way To Build', '2011-10-22 13:30:00Z', '2011-10-22 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 99, 'Polyglot Web Programming With Grails', '2011-10-22 13:30:00Z', '2011-10-22 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 100, 'Getting to know Git: How to give back to Grails', '2011-10-22 13:30:00Z', '2011-10-22 15:00:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 101, 'Extending Spring Integration', '2011-10-22 15:15:00Z', '2011-10-22 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 102, 'Inside the Greenhouse', '2011-10-22 15:15:00Z', '2011-10-22 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 103, 'Monitoring Spring Batch and Integration with Hyperic', '2011-10-22 15:15:00Z', '2011-10-22 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 104, 'Graph Database Persistence using Neo4J and Roo', '2011-10-22 15:15:00Z', '2011-10-22 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 105, 'Groovy + The Semantic Web', '2011-10-22 15:15:00Z', '2011-10-22 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 106, 'Beauty and the Beast: Software-Design for Build Systems', '2011-10-22 15:15:00Z', '2011-10-22 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 107, 'Grails and Messaging with AMQP/RabbitMQ', '2011-10-22 15:15:00Z', '2011-10-22 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 108, 'When GSP is not enough: using ZK with Grails', '2011-10-22 15:15:00Z', '2011-10-22 16:45:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 109, 'Introduction to Spring Security 3 and 3.1', '2011-10-22 19:45:00Z', '2011-10-22 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 110, 'Next-Generation Spring MVC with Spring Roo', '2011-10-22 19:45:00Z', '2011-10-22 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 111, 'GemFire SQLDataFabric: "noSQL database" scalability using SQL', '2011-10-22 19:45:00Z', '2011-10-22 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 112, 'An introduction to Spring.NET for Java developers', '2011-10-22 19:45:00Z', '2011-10-22 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 113, 'Metaprogramm ing the Microkernel: Groovy + NetKernel', '2011-10-22 19:45:00Z', '2011-10-22 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 114, 'Gradle in the Enterprise', '2011-10-22 19:45:00Z', '2011-10-22 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 115, 'Integrating Grails with Daisy CMS', '2011-10-22 19:45:00Z', '2011-10-22 21:15:00Z',
...
insert into EventSession (event, id, title, startTime, endTime, description, hashtag, track, venue, room) values (1, 116, 'Grails + CouchDB', '2011-10-22 19:45:00Z', '2011-10-22 21:15:00Z',
