...
insert into AccountProvider (name, apiKey, secret, requestTokenUrl, authorizeUrl, callbackUrl, accessTokenUrl) values ('twitter', 'kqAm0GiPCT2owEtyTLPsug', '3461TFWV52VJuppKeaWMi8lKOxXMZtYLPGISq4nJ5s', 'https://twitter.com/oauth/request_token', 'https://twitter.com/oauth/authorize?oauth_token={token}', 'http://localhost:8080/greenhouse/connect/twitter', 'https://twitter.com/oauth/access_token');
insert into AccountProvider (name, apiKey, secret, appId) values ('facebook', '21aa96c8bc23259d0dd2ab99e496c306', 'f9f627194d471fb915dfbc856d347288', 157702280911244);
-- insert into AccountProvider (name, apiKey, secret, requestTokenUrl, authorizeUrl, callbackUrl, accessTokenUrl) values ('linkedin', 'elcLPr8RxIXifjn5RKwaTNxKPap4dYrr9ANuJ-abZNkTjbT3mSOVT7IhSfsF27XP', 'QiMWSBRBBM43wFuqpn8XtXqdfLB6A0TJUQslBjtuQAwYCOcIdvRaotT9c50I72pk', 'https://api.linkedin.com/uas/oauth/requestToken', 'https://www.linkedin.com/uas/oauth/authorize?oauth_token={token}', 'http://localhost:8080/greenhouse/connect/linkedin', 'https://api.linkedin.com/uas/oauth/accessToken');
...
insert into Event (title, startTime, endTime, slug, description, memberGroup) values ('SpringOne/2GX', '2010-10-19 22:00:00Z', '2010-10-22 22:00:00Z', 'chicago', 'SpringOne 2GX is a one-of-a-kind conference for application developers, solution architects, web operations and IT teams who develop, deploy and manage business applications.', 1);
insert into Event (title, startTime, endTime, slug, description, slug, memberGroup) values ('Spring Integration 2', '2010-09-21 22:30:00Z', '2010-09-22 23:00:00Z', 'int', 'Come learn the latest the Spring Integration project has to offer', 2);
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (1, 1, 'Mastering MVC 3', '2010-10-20 17:45:00Z', '2010-10-20 19:15:00Z',
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (1, 2, 'Inside Web Flow 3 Development', '2010-10-20 19:45:00Z', '2010-10-20 21:15:00Z',
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (1, 3, 'Developing Social-Ready Web Applications', '2010-10-21 17:45:00Z', '2010-10-21 19:15:00Z',
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (1, 4, 'Choices in Mobile Application Development', '2010-10-21 19:45:00Z', '2010-10-21 21:15:00Z',
