...
public class ConnectionRepositoryConfig {
	...
	@Bean
	public ConnectionRepository connectionRepository(DataSource dataSource, TextEncryptor encryptor) {
		return new JdbcConnectionRepository(dataSource, encryptor);
	}
