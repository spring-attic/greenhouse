...
public class JdbcAccountProviderFactory implements AccountProviderFactory {
	...
	private static final String SELECT_ACCOUNT_PROVIDER_BY_NAME = "select apiKey, secret, appId, requestTokenUrl, authorizeUrl, accessTokenUrl from AccountProvider where name = ?";
