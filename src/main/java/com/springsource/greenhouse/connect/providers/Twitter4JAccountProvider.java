...
public class Twitter4JAccountProvider extends AbstractAccountProvider<Twitter> {
	public Twitter4JAccountProvider(AccountProviderParameters parameters,
			AccountConnectionRepository connectionRepository) {
		super(parameters, connectionRepository);
	}

	public Twitter createApi(OAuthToken accessToken) {
	...
	public String getProviderAccountId(Twitter api) {
		try {
	...
	public String getProviderProfileUrl(Twitter api) {
		try {
