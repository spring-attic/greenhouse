...
public final class FacebookAccountProvider extends AbstractAccountProvider<FacebookOperations> {
	...
	protected FacebookOperations createApi(OAuthToken accessToken) {
		if (accessToken == null) {
	...
	protected String getProviderAccountId(FacebookOperations api) {
		return api.getProfileId();
	}

	protected String getProviderProfileUrl(FacebookOperations api) {
