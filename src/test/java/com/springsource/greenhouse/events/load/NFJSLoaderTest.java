...
public class NFJSLoaderTest {
	...
	public void loadOnce() {
		...
		assertVenueData("Chicago Marriott Downtown Magnificent Mile", "540 North Michigan Avenue null Chicago, IL 60611", 41.8920052, -87.6247001, "http://maps.google.com/maps?q=540+North+Michigan+Avenue,+Chicago,+IL+60611&hl=en", 1L);
	...
	public void loadOnceThenUpdateNewData() {
		...
		assertVenueData("Pocatello Convention Center", "1234 South Arizona Drive null Pocatello, ID 83201", 41.8920052, -87.6247001, "http://maps.google.com/maps?q=1234+South+Arizona+Drive,+Pocatello,+ID+83201&hl=en", 1L);
