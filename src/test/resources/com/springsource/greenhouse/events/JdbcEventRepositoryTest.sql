...
insert into Event (title, startDate, endDate, location, description, memberGroup) values ('Soon_Event', '2010-10-19', '2010-10-22', 'Chicago, IL', 'This event is soon', 1);
...
insert into EventSession (code, title, startTime, endTime, description, event, track) values (201, 'Developing Social-Ready Web Applications', '2010-10-20', '2010-10-20', 
...
insert into EventSession (code, title, startTime, endTime, description, event, track) values (202, 'Mastering MVC 3', '2010-10-19', '2010-10-19',
