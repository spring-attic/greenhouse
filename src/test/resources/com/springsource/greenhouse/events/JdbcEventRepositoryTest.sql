...
insert into Event (title, startTime, endTime, location, description, name, memberGroup) values ('Soon_Event', '2010-08-02 00:00:00Z', '2010-08-03 00:00:00Z', 'Chicago, IL', 'This event is soon', 'chitown', 1);
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (2, 1, 'Mastering MVC 3', '2010-08-02 14:00:00Z', '2010-08-02 15:00:00Z',
...
insert into EventSession (event, number, title, startTime, endTime, description, hashtag, track) values (2, 2, 'Developing Social-Ready Web Applications', '2010-08-02 15:00:00Z', '2010-08-02 16:00:00Z', 
...
insert into EventSessionFavorite (event, session, attendee) values (2, 1, 2);